    ...
    <div style={{ minHeight: '100vh', background: darkMode ? 'linear-gradient(120deg, #181c2f 60%, #232946 100%)' : 'linear-gradient(120deg, #e0e7ff 60%, #a084ee 100%)', padding: '40px 5%' }}>
      <div style={{ maxWidth: '100%' }}>
        ...
        <Row className="mb-5">
          ...
          {[
            { title: 'Customer Support', desc: '24/7 customer support chatbot with ticket management and issue resolution.', icon: '🤖' },
            { title: 'E-commerce', desc: 'Shopping assistant chatbot with product recommendations and order tracking.', icon: '🛒' },
            { title: 'Lead Generation', desc: 'Lead qualification chatbot with form collection and CRM integration.', icon: '📊' },
            { title: 'FAQ', desc: 'Knowledge base chatbot with instant answers and self-service capabilities.', icon: '❓' },
            { title: 'Booking', desc: 'Appointment booking chatbot with calendar integration and confirmation.', icon: '📅' },
            { title: 'Education', desc: 'Learning assistant chatbot with course guidance and progress tracking.', icon: '📚' }
          ].map((template, idx) => (
