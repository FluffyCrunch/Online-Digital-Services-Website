...
import { FaPen, FaSearch, FaBullhorn, FaRocket, FaUsers, FaChartLine } from 'react-icons/fa';
  ...
  const projects = [
    {
      ...
      desc: "Compelling product descriptions that drive sales",
      img: "https://images.unsplash.com/photo-1455390582262-044cdead277a?auto=format&fit=crop&w=400&q=80",
      category: "E-commerce"
    },
    {
      title: "Blog Content Strategy",
      desc: "SEO-optimized blog content for tech startup",
    ...
    },
    {
      ...
      desc: "Persuasive ad copy for social media campaigns",
    ...
    <div style={{ minHeight: '100vh', background: darkMode ? 'linear-gradient(120deg, #181c2f 60%, #232946 100%)' : 'linear-gradient(120deg, #e0e7ff 60%, #a084ee 100%)', padding: '40px 5%' }}>
      <div style={{ maxWidth: '100%' }}>
        ...
        <Row className="align-items-center mb-5">
          ...
          <Col lg={6}>
            ...
            <p style={{ fontSize: '1.2rem', color: darkMode ? '#e0e7ff' : '#232946', marginBottom: '30px', lineHeight: 1.6 }}>
              Transform your brand with compelling content that converts. Our expert writers create engaging copy that resonates with your audience and drives results.
            </p>
          </Col>
        </Row>
                ...
                <Col md={6} className="d-flex align-items-center">
                  <Card.Body style={{ padding: '40px' }}>
                    ...
                    <p style={{ color: darkMode ? '#e0e7ff' : '#232946', lineHeight: 1.6, marginBottom: '20px' }}>
                      Our team of experienced content writers, copywriters, and SEO specialists create compelling content that engages your audience, improves search rankings, and drives conversions across all platforms.
                    </p>
                    <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap' }}>
                      ...
                      <div style={{ textAlign: 'center' }}>
                        <FaBullhorn size={24} color="#4f8cff" />
                        <div style={{ fontSize: '0.9rem', color: darkMode ? '#e0e7ff' : '#232946', marginTop: '5px' }}>Marketing</div>
                      </div>
                      <div style={{ textAlign: 'center' }}>
        ...
        <Row className="mb-5">
          ...
          <Col md={4} className="mb-4">
            <Card style={{ 
              ...
              <h4 style={{ color: darkMode ? '#4f8cff' : '#232946', marginBottom: '15px' }}>SEO Content</h4>
              <p style={{ color: darkMode ? '#e0e7ff' : '#232946' }}>
                Search engine optimized content that ranks well and drives organic traffic to your website.
              </p>
            </Card>
          </Col>
          <Col md={4} className="mb-4">
            <Card style={{ 
              ...
              <FaBullhorn size={48} color="#4f8cff" style={{ marginBottom: '20px' }} />
              <h4 style={{ color: darkMode ? '#4f8cff' : '#232946', marginBottom: '15px' }}>Copywriting</h4>
              <p style={{ color: darkMode ? '#e0e7ff' : '#232946' }}>
                Persuasive copy for ads, landing pages, and marketing materials that convert visitors into customers.
              </p>
            </Card>
          </Col>
          <Col md={4} className="mb-4">
            <Card style={{ 
              ...
              <h4 style={{ color: darkMode ? '#4f8cff' : '#232946', marginBottom: '15px' }}>Blog Writing</h4>
              <p style={{ color: darkMode ? '#e0e7ff' : '#232946' }}>
                Engaging blog posts and articles that establish thought leadership and build audience trust.
              </p>
            </Card>
          </Col>
        </Row>
        ...
        <Row className="mb-5">
          ...
          {[
            { title: 'Blog Posts', desc: 'Engaging blog content with SEO optimization, storytelling, and audience engagement.', icon: '📝' },
            { title: 'Website Copy', desc: 'Compelling website content with clear messaging, CTAs, and conversion optimization.', icon: '🌐' },
            { title: 'Email Marketing', desc: 'Email campaigns with personalized content, automation, and conversion tracking.', icon: '📧' },
            { title: 'Social Media', desc: 'Social media content with platform-specific optimization and engagement strategies.', icon: '📱' },
            { title: 'Product Descriptions', desc: 'Product copy with benefits-focused writing, SEO keywords, and conversion elements.', icon: '🛍️' },
            { title: 'Case Studies', desc: 'Detailed case studies with problem-solution narratives and measurable results.', icon: '📊' }
          ].map((template, idx) => (
          ...
          <Col lg={12}>
            <div style={{ 
              ...
              <p style={{ fontSize: 17, color: darkMode ? '#e0e7ff' : '#232946', marginBottom: 18 }}>
                Contact us for a free consultation and see how we can create compelling content that converts visitors into customers.
              </p>
